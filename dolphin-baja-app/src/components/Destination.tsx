...
export default function Destination() {
  return (
    // 👇 1. Fondo transparente para ver las luces del Home
    <section id="ubicacion" className="relative z-10 w-full py-24 px-6 md:px-20 overflow-hidden scroll-mt-20">
      <div className="max-w-5xl mx-auto text-center relative z-20">
        ...
        >
          ...
          <h2 className="font-title text-2xl md:text-4xl text-white mb-6 drop-shadow-lg">
            #Loreto_donde_el_lujo_es_la_<span className="text-yellow-400">naturaleza</span>
          </h2>
          <p className="text-slate-300 mb-12 max-w-2xl mx-auto text-lg font-body drop-shadow-md">
        ...
        <motion.div
          ...
          // 👇 2. Contenedor del mapa con borde de cristal y sombra profunda
          className="w-full h-[400px] md:h-[500px] rounded-[2rem] overflow-hidden border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.5)] relative bg-dark/50"
        >
          {/* Iframe del Mapa */}
          <iframe
            ...
            width="100%"
            height="100%"
            // Filtro para modo oscuro oceánico
            ...
            className="transition-all duration-700 hover:filter-none" // Al poner el mouse se quita el filtro para ver colores reales
          ></iframe>

          {/* 👇 3. Tarjeta flotante Liquid Glass */}
          <div className="hidden md:block absolute bottom-6 right-6 w-80 bg-dark/60 backdrop-blur-2xl p-7 rounded-[1.5rem] border border-white/10 text-left shadow-[0_16px_40px_rgba(0,0,0,0.6)] group hover:border-cyan-400/30 transition-colors duration-500">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="font-title text-white text-xl">Visítanos</h4>
              </div>

              <p className="text-sm text-slate-300 mb-5 font-body leading-relaxed">
                Estamos ubicados en el corazón de Loreto, listos para planear tu aventura.
              </p>
