...
export default function History() {
  ...
  // 1. Título de la Sección (Consistente con OurStory)
  const headingClass = `
  ...
  // 4. Tarjeta de Evento (Matte en Dark, Clean en Light)
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-8 md:space-y-12 relative">
          ...
          {content.events.map((event, idx) => (
            ...
            >
              {/* Brillo interno al hover (Solo Dark Mode para efecto neón sutil) */}
