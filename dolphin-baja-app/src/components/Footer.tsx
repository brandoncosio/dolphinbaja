...
export default function Footer() {
  ...
  return (
    <footer className="relative pt-24 md:pt-32 pb-8 md:pb-10 overflow-hidden transition-colors duration-500 z-10 border-t 
      dark:bg-dark dark:border-white/10 dark:text-slate-200 
      bg-slate-50 border-slate-200 text-slate-600">

      {/* =========================================
          FONDO OCEÁNICO (Dual Texture - Ajustado)
      ========================================= */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <img
          ...
          className="w-full h-full object-cover object-bottom transition-all duration-500
            /* DARK MODE: Oscuro y profundo */
            dark:opacity-50 dark:grayscale-[30%] dark:mix-blend-luminosity
            /* LIGHT MODE (Corregido): Visible (25%), casi a color natural (gray-20) y mezclado suavemente */
            opacity-25 grayscale-[20%] mix-blend-multiply"
        />

        {/* Gradiente Adaptable */}
        <div className="absolute inset-0 bg-gradient-to-b transition-colors duration-500
          /* DARK: De negro a azul marino */
          dark:from-dark dark:via-dark/30 dark:to-navy/90
          /* LIGHT: De blanco a transparente en el centro (para ver la foto) a blanco abajo */
          from-slate-50/90 via-slate-50/40 to-slate-200/90"
        />

        {/* Luz de fondo sutil */}
        <div
          className="absolute -bottom-[10%] md:-bottom-[20%] left-1/2 -translate-x-1/2 w-[120%] md:w-[800px] h-[200px] md:h-[300px] rounded-full blur-[100px] md:blur-[150px] transition-colors duration-500
          dark:bg-cyan-400/15 
          bg-cyan-400/10"
              ...
              <ul className="space-y-3 md:space-y-4 font-body w-full">
                {col.links.map((link, i) => (
                  <li key={i}>
                    <Link
                      to={link.path}
                      className="font-medium transition-colors inline-flex items-center justify-center sm:justify-start gap-2 group text-base w-full sm:w-auto py-1 sm:py-0
                    ...
                    >
                      <i className="ri-arrow-right-s-line opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 hidden sm:inline-block
                        dark:text-cyan-400 text-cyan-600"></i>
            ...
            <ul className="space-y-5 font-body mb-8 w-full">
              ...
              <li className="flex flex-row items-center sm:items-start justify-center sm:justify-start gap-4 group transition-colors
                ...
                <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 transition-all duration-300 shadow-sm
                  ...
                  <i className="ri-map-pin-2-fill text-lg transition-colors
                    dark:text-cyan-400 dark:group-hover:text-dark
                    text-cyan-600"></i>
                </div>
              ...
              <li className="flex justify-center sm:justify-start">
                <a href="https://wa.me/526131182311" target="_blank" rel="noopener noreferrer" className="flex flex-row items-center gap-4 group transition-colors
                  dark:text-slate-300 text-slate-600">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 transition-all duration-300 shadow-sm
                    dark:bg-white/5 dark:border-white/10 dark:group-hover:bg-yellow-400 dark:group-hover:border-yellow-400
                    bg-white border border-slate-200 group-hover:bg-yellow-50 group-hover:border-yellow-300">
                    <i className="ri-whatsapp-fill text-xl transition-colors
                      dark:text-yellow-400 dark:group-hover:text-dark
                      text-yellow-600"></i>
                  </div>
            ...
            <div className="flex gap-3 justify-center sm:justify-start w-full flex-wrap">
              {socialLinks.map((social, idx) => (
                <a
                  ...
                  style={{ willChange: 'transform' }}
                  className="w-11 h-11 md:w-12 md:h-12 rounded-xl flex items-center justify-center shadow-md transition-all duration-300 group hover:-translate-y-1
                  dark:bg-white/5 dark:border-white/15 dark:text-slate-200 dark:hover:bg-cyan-400 dark:hover:text-dark dark:hover:border-cyan-400 dark:hover:shadow-[0_10px_20px_rgba(34,211,238,0.4)]
