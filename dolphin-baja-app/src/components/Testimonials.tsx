      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 relative z-10">
        {content.list.map((testimonial: any, idx: number) => (
          ...
          >
            ...
            <p className="font-body text-slate-600 dark:text-slate-300 leading-relaxed flex-grow relative z-10 italic mb-8">
              "{testimonial.text}"
            </p>
            ...
            <div className="mt-auto flex items-center gap-4 relative z-10 border-t border-slate-100 dark:border-white/10 pt-4">
              ...
              <div>
                <h4 className="font-title text-navy dark:text-white text-lg leading-none">{testimonial.name}</h4>
                <span className="font-body text-xs text-slate-400 dark:text-slate-500 mt-1 block">
                  {testimonial.date}
                </span>
              </div>
            </div>
