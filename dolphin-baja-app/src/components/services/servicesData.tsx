        ...
        es: {
            fundives: [
                ...
                },
                {
                    ...
                    includes: ["Tarifas del parque marino", "Lunch, fruta y agua", "Plomos y tanques", "Luz química para el chaleco", "🐙 Equipo de buceo", "🐙 Propinas"],
                    extraContent: (
            ...
            intro: [
                {
                    ...
                    includes: ["Clase teórica corta", "Instrucción personalizada", "Renta completa de equipo", "Lunch, snacks y bebidas", "Brazalete del Parque Marino"]
                },
                {
        ...
        en: {
            fundives: [
                ...
                },
                {
                    ...
                    includes: ["Marine park fees", "Lunch, fruit, water", "Weights & tanks", "Night light stick for the BCD", "🐙 Dive gear", "🐙 Gratuities"],
                    extraContent: (
                        <div className="mt-4 p-5 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 space-y-4">
